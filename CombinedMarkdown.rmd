...
```{r}
#error types
matchLASSO <- data.frame(cbind(pred_resultsLASSO, LASSOresults = test$AttritionClass))
names(matchLASSO) <- c("pred_resultsLASSO", "LASSOresults")

matchLASSO$error[(matchLASSO$pred_resultsLASSO == 1 & matchLASSO$LASSOresults ==1)] <- 'True positive'
matchLASSO$error[(matchLASSO$pred_resultsLASSO == 0 & matchLASSO$LASSOresults ==1)] <- 'False negative'
matchLASSO$error[(matchLASSO$pred_resultsLASSO == 0 & matchLASSO$LASSOresults ==0)] <- 'True negative'
matchLASSO$error[(matchLASSO$pred_resultsLASSO == 1 & matchLASSO$LASSOresults ==0)] <- 'False positive'
